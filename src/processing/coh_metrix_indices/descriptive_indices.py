...
class DescriptiveIndices:
    ...
    def get_mean_of_length_of_paragraphs(self, text: str, workers: int=-1) -> float:
        ...
        return self._get_mean_of_metric(text, disable_pipeline=disable_pipeline, counter_function=count_length_of_paragraphs, workers=workers)

    def get_std_of_length_of_paragraphs(self, text: str, workers: int=-1) -> float:
        """
        This method returns the standard deviation of the mean of sentences of each paragraph.
        ...
        return self._get_std_of_metric(text, disable_pipeline=disable_pipeline, counter_function=count_length_of_paragraphs, workers=workers)

    def get_mean_of_length_of_sentences(self, text: str, workers: int=-1) -> float:
        """
        This method returns the average amount of words in each sentence.
        ...
        return self._get_mean_of_metric(text, disable_pipeline=disable_pipeline, counter_function=count_length_of_sentences, workers=workers)


    def get_std_of_length_of_sentences(self, text: str, workers: int=-1) -> float:
        """
        This method returns the standard deviation of the amount of words in each sentence.
        ...
        return self._get_std_of_metric(text, disable_pipeline=disable_pipeline, counter_function=count_length_of_sentences, workers=workers)


    def get_mean_of_length_of_words(self, text: str, workers: int=-1) -> float:
        """
        This method returns the average amount of letters in each word.
        ...
        return self._get_mean_of_metric(text, disable_pipeline=disable_pipeline, counter_function=count_letters_per_word, workers=workers)


    def get_std_of_length_of_words(self, text: str, workers=-1) -> float:
        """
        This method returns the standard deviation of the amount of letters in each word.
        ...
        return self._get_std_of_metric(text, disable_pipeline=disable_pipeline, counter_function=count_letters_per_word, workers=workers)

    def get_mean_of_syllables_per_word(self, text: str, workers=-1) -> float:
        """
        This method returns the average amount of syllables in each word.
        ...
        return self._get_mean_of_metric(text, disable_pipeline=disable_pipeline, counter_function=count_syllables_per_word, workers=workers)

    def get_std_of_syllables_per_word(self, text: str,  workers=-1) -> float:
        """
        This method returns the standard deviation of the amount of syllables in each word.
